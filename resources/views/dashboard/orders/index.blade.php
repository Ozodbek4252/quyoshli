                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="user" class="form-control"
                                                        value="{{ request()->get('user') }}" placeholder="Пользователь"
                                                        name="user">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="status" name="delivery_status">
                                                        ...
                                                        <option value="processing"
                                                            @if (request('delivery_status') == 'processing') selected @endif>В обработке
                                                        </option>
                                                        <option value="collected"
                                                            @if (request('delivery_status') == 'collected') selected @endif>Собран
                                                        </option>
                                                        <option value="waiting_buyer"
                                                            @if (request('delivery_status') == 'waiting_buyer') selected @endif>Ожидает
                                                            покупателя</option>
                                                        <option value="in_way"
                                                            @if (request('delivery_status') == 'in_way') selected @endif>В пути
                                                        </option>
                                                        <option value="closed"
                                                            @if (request('delivery_status') == 'closed') selected @endif>Закрыт
                                                        </option>
                                                        <option value="cancelled"
                                                            @if (request('delivery_status') == 'cancelled') selected @endif>Отменен
                                                        </option>
                                                        <option value="replacement"
                                                            @if (request('delivery_status') == 'replacement') selected @endif>Замена
                                                        </option>
                                                        <option value="completed"
                                                            @if (request('delivery_status') == 'completed') selected @endif>Завершен
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="pay_status" name="pay_status">
                                                        <option selected disabled>Не выбрано</option>
                                                        <option value="cancelled"
                                                            @if (request('pay_status') == 'cancelled') selected @endif>Отменено
                                                        </option>
                                                        <option value="payed"
                                                            @if (request('pay_status') == 'payed') selected @endif>Оплачено
                                                        </option>
                                                        <option value="waiting"
                                                            @if (request('pay_status') == 'waiting') selected @endif>Не оплачено
                                                        </option>
                                                        <option value="cash"
                                                            @if (request('pay_status') == 'cash') selected @endif>Наличный
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="delivery_type" name="delivery_type">
                                                        ...
                                                        <option value="delivery"
                                                            @if (request('delivery_type') == 'delivery') selected @endif>Стандартная
                                                            доставка</option>
                                                        <option value="pickup"
                                                            @if (request('delivery_type') == 'pickup') selected @endif>Самовывоз из
                                                            пункта выдачи</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group dropleft mr-1 mb-1">
                                                    <button type="button"
                                                        class="btn @if ($order->status == 'delivered') btn-success @elseif($order->status == 'cancelled') btn-danger @elseif($order->status == 'processing') btn-primary @elseif($order->status == 'waiting') btn-warning @endif  dropdown-toggle waves-effect waves-light"
                                                    ...
                                                    <div class="dropdown-menu" x-placement="left-start"
                                                        ...
                                                        @if (
                                                            !empty(auth()->user()->role->permissions['order_status']['processing']) ||
                                                                !empty(auth()->user()->role->permissions['order_status']['cancelled']))
                                                        ...
                                                        @if (
                                                            !empty(auth()->user()->role->permissions['order_status']['processing']) ||
                                                                !empty(auth()->user()->role->permissions['order_status']['collected']))
                                                            <a class="dropdown-item @if ($order->status == 'collected') disabled @endif"
                                                                onclick="return confirm('Вы действительно хотите изменить статус')"
                                                        ...
                                                        @if (
                                                            ($order->type_delivery == 'pickup' && !empty(auth()->user()->role->permissions['order_status']['waiting_buyer'])) ||
                                                                ($order->type_delivery == 'pickup' && !empty(auth()->user()->role->permissions['order_status']['closed'])) ||
                                                                ($order->type_delivery == 'pickup' && !empty(auth()->user()->role->permissions['order_status']['collected'])))
                                                            <a class="dropdown-item @if ($order->status == 'waiting_buyer') disabled @endif"
                                                                onclick="return confirm('Вы действительно хотите изменить статус')"
                                                                href="{{ route('dashboard.orders.status', [$order->id, 'waiting_buyer']) }}">
                                                                Ожидает покупателя
                                                            </a>
                                                        @endif

                                                        @if (
                                                            ($order->type_delivery == 'delivery' && !empty(auth()->user()->role->permissions['order_status']['in_way'])) ||
                                                                ($order->type_delivery == 'delivery' && !empty(auth()->user()->role->permissions['order_status']['closed'])))
                                                            <a class="dropdown-item @if ($order->status == 'in_way') disabled @endif"
                                                                onclick="return confirm('Вы действительно хотите изменить статус')"
                                                                href="{{ route('dashboard.orders.status', [$order->id, 'in_way']) }}">
                                                                В пути
                                                            </a>
                                                        @endif

                                                        @if (!empty(auth()->user()->role->permissions['order_status']['closed']))
                                                            <a class="modal-comment dropdown-item @if ($order->status == 'closed') disabled @endif"
                                                                data-toggle="modal" data-target="#staticBackdrop"
                                                                data-id="{{ $order->id }}" data-type="closed">
                                                        ...
                                                        @if (!empty(auth()->user()->role->permissions['order_status']['cancelled']))
                                                            <a class="modal-comment dropdown-item @if ($order->status == 'cancelled') disabled @endif"
                                                                data-toggle="modal" data-target="#staticBackdrop"
                                                                data-id="{{ $order->id }}" data-type="cancelled">
                                                                {{-- href="{{ route('dashboard.orders.status', [$order->id, 'cancelled']) }}" --}}
                                                                Отменен
                                                            </a>
                                                        @endif
                                                        ...
                                                        @if (
                                                            !empty(auth()->user()->role->permissions['order_status']['replacement']) ||
                                                                !empty(auth()->user()->role->permissions['order_status']['closed']))
                                                            <a class="modal-comment dropdown-item @if ($order->status == 'replacement') disabled @endif"
                                                                data-toggle="modal" data-target="#staticBackdrop"
                                                                data-id="{{ $order->id }}" data-type="replacement">
                                                                {{-- href="{{ route('dashboard.orders.status', [$order->id, 'replacement']) }} --}}
                                                                Замена
                                                            </a>
                                                        @endif

                                                        @if (!empty(auth()->user()->role->permissions['order_status']['completed']))
                                                            <a class="modal-comment dropdown-item @if ($order->status == 'completed') disabled @endif"
                                                                data-toggle="modal" data-target="#staticBackdrop"
