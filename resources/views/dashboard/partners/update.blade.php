        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <form class="form form-vertical" action="{{ route('dashboard.partner.update', $partner->id) }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="form-body">
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" required class="form-control @error('name') is-invalid @enderror"
                                                           name="name" value="{{ old('name', $partner->name) }}" placeholder="@lang('admin.partners.name')">
                                                    @error('name')
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="image">@lang('admin.partners.image') * @if(is_file($partner->image)) <a href="/{{ $partner->image }}" target="_blank">@lang('admin.see')</a> @endif</label>
