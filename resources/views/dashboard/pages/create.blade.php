                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 float-left">
                                                    <fieldset class="form-label-group">
                                                        <textarea class="form-control" name="keywords[ru]" id="label-keywords-ru" rows="3" placeholder="@lang('admin.settings.keywords')  RU">{{ old('keywords.ru') }}</textarea>
                                                ...
                                                <div class="col-md-6 float-left">
                                                    <fieldset class="form-label-group">
                                                        <textarea class="form-control" name="keywords[uz]" id="label-keywords" rows="3" placeholder="@lang('admin.settings.keywords') UZ">{{ old('keywords.uz') }}</textarea>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-md-6 float-left">
                                                    <fieldset class="form-label-group">
                                                        <textarea class="form-control"  name="descriptions[ru]" id="label-description-ru" rows="3" placeholder="@lang('admin.settings.description') RU">{{ old('descriptions.ru') }}</textarea>
                                                ...
                                                <div class="col-md-6 float-left">
                                                    <fieldset class="form-label-group">
                                                        <textarea class="form-control"  name="descriptions[uz]" id="label-description" rows="3" placeholder="@lang('admin.settings.description') UZ">{{ old('descriptions.uz') }}</textarea>
