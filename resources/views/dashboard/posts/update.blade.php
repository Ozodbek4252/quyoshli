...
@section('content')
    <div class="row">
        <form class="form form-vertical" action="{{ route('dashboard.post.update', [$lang, $post->id]) }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" required class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $post->name) }}" placeholder="@lang('admin.posts.name')">
                                                    @error('name')
                                            ...
                                            <div class="col-12">
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="select2 form-control" name="type" required>
                                                        ...
                                                        <option value="news" {{ $post->type === 'news' ? 'selected' : '' }}>@lang('admin.posts.type.news')</option>
                                                        <option value="article" {{ $post->type === 'article' ? 'selected' : '' }}>@lang('admin.posts.type.article')</option>
                                                        <option value="sales" {{ $post->type === 'sales' ? 'selected' : '' }}>@lang('admin.posts.type.sales')</option>
                                                        <option value="media" {{ $post->type === 'media' ? 'selected' : '' }}>@lang('admin.posts.type.media')</option>
                                                    </select>
                                                </fieldset>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="image">@lang('admin.brands.image') @if(is_file($post->image)) <a href="/{{ $post->image }}" target="_blank">@lang('admin.see')</a> @endif</label>
                                            <input type="file" id="image" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" placeholder="@lang('admin.posts.image')">
                                            @error('image')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <fieldset class="form-label-group">
                                        <textarea class="form-control"  name="keywords" id="label-descriptions-ru" rows="3" placeholder="@lang('admin.settings.keywords')">{{ old('keywords', $post->keywords) }}</textarea>
                                ...
                                <div class="col-12">
                                    <fieldset class="form-label-group">
                                        <textarea class="form-control"  name="descriptions" id="label-keywords-ru" rows="3" placeholder="@lang('admin.settings.description')">{{ old('description', $post->descriptions) }}</textarea>
                            ...
                            <div class="form-group mt-1">
                                <fieldset class="checkbox">
                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                        <input type="checkbox" value="1" {{ $post->topped ? 'checked' : '' }} name="topped">
