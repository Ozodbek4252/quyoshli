...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="/vendor/dashboard/app-assets/css/core/menu/menu-types/vertical-menu.css">
    <!-- END: Page CSS-->
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @can('view', 'staffs')
                    <li class="nav-item {{ active([route('dashboard.staffs'), route('dashboard.staffs') . '/*']) }}"><a
                            href="{{ route('dashboard.staffs') }}">
                            <i class="feather icon-users"></i>
                            <span class="menu-title" data-i18n="">
                ...
                @can('view', 'roles')
                    <li class="nav-item {{ active([route('dashboard.roles'), route('dashboard.roles') . '/*']) }}"><a
