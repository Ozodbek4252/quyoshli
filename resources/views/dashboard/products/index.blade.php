                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" class="form-control" value="{{ request()->get('name') }}" placeholder="Названия" name="name">
                                            </div>
                                        </div>
...
{{--                                                <input type="text" id="brand" class="form-control" value="{{ request()->get('brand') }}" placeholder="Бренд" name="brand">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
                                                ...
                                                <select class="form-control" id="category" name="category">
                                                    ...
                                                    @foreach($categories as $category)
                                                        ...
                                                        @foreach($category->parents as $parent)
                                                            <option value="{{ $parent->id }}" @if(request('category') == $parent->id) selected @endif>
                                                                {{ $parent->getName() }}
                                                            </option>

                                                            @foreach($parent->parents as $parentt)
                                                                <option value="{{ $parentt->id }}" @if(request('category') == $parentt->id) selected @endif>
                                                                    {{ $parentt->getName() }}
                                                                </option>
                                                            @endforeach
                                                        @endforeach
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="in_stock" name="in_stock">
                                                    ...
                                                    <option value="1" @if(request('in_stock') == '1') selected @endif>В наличии</option>
                                                    <option value="0" @if(request('in_stock') == '0') selected @endif>нет в наличии</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="article_number" class="form-control" value="{{ request()->get('article_number') }}" placeholder="Артикул" name="article_number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="{{ route('dashboard.products') }}" class="btn btn-outline-warning mr-1 mb-1 waves-effect waves-light">Сброс</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                            ...
                                            @can('delete', 'products')
                                                <td class="text-right">
                                                    <div class="form-group">
                                                        <fieldset class="checkbox">
                                                            <div class="vs-checkbox-con vs-checkbox-primary">
                                                                <input type="checkbox" value="{{ $product->id }}" name="prod_id[]" class="change-check"
    ...
    {{--                                            </a>--}}
                                                ...
                                                @can('update', 'products')
                                                    <a href="{{ route('dashboard.product.update', $product->id) }}" class="btn btn-icon btn-primary btn-sm" data-toggle="tooltip" data-original-title="@lang('admin.edit')">
                                                        <i class="feather icon-edit"></i>
                                                    </a>
                                                @endcan

                                                @can('delete', 'products')
                                                    <a href="{{ route('dashboard.product.delete', $product->id) }}" class="btn btn-icon btn-danger btn-sm" data-toggle="tooltip" onclick="return confirm('@lang('admin.are_you_sure')')" data-original-title="@lang('admin.delete')">
                        ...
                        <div class="card-footer" id="show-action">
                            <button type="submit" name="action" value="delete" class="btn btn-danger">@lang('admin.products.delete_mass')</button>
{{--                            <button type="submit" name="action" value="status-active" class="btn btn-success">@lang('admin.products.status_active')</button>--}}
                            <button type="submit" name="action" value="status-deactivate" class="btn btn-warning">@lang('admin.products.deactivate')</button>
                        </div>
                    </form>
                </div>
            </div>
