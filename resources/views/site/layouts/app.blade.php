        ...
        <div class="topbar">
                ...
                <div class="container">
                    <div class="topbar-top__left">
                        <div class="just-call d-flex d-md-none ml-auto mr-3" style="opacity: 0; visibility: hidden">
                            ...
                            <a href="javascript:void(0)" class="d-flex d-lg-none" data-target="#feedback"
                                data-toggle="modal">
                        ...
                        <div class="lang d-block d-md-none">
                            <div class="lang-selected">{{ app()->getLocale() === 'ru' ? 'Ru' : 'Uz' }} <i
                                    class="fa fa-caret-down"></i></div>
                            <div class="lang-list">
                                <a class="{{ app()->getLocale() === 'ru' ? 'active disabled' : '' }}"
                                    href="{{ route('site.setLocale', 'ru') }}">Ru</a>
                                <a class="{{ app()->getLocale() === 'uz' ? 'active disabled' : '' }}"
                                    href="{{ route('site.setLocale', 'uz') }}">Uz</a>
                            </div>
                        </div>
            ...
            <div class="topbar-bottom">
                <div class="container">
                    ...
                    <form action="{{ route('search') }}" method="get">
                        <div class="search">
                            <input type="text" name="name" value="{{ request()->get('name') }}"
                                placeholder="@lang('app.search.search')">
                    ...
                    <div class="just-call">
                        <a href="tel:{{ $setting->getPhone() }}"><i class="fas fa-mobile-alt"></i>
                            <span>{{ $setting->getPhone() }}</span></a>
                        <a href="javascript:" style="opacity: 0; visibility: hidden" data-target="#feedback"
                            data-toggle="modal">@lang('app.callback.title')</a>
                    </div>
                    ...
                    @guest
                        <a href="javascript:void(0)" class="d-flex d-md-none sign-in" data-target="#login"
                            data-toggle="modal">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 mb-3 mb-lg-0">
                            ...
                            <div class="copyright">{{ now()->format('Y') }} © <a href="/">Alistore.uz</a> |
                                @lang('app.layout.rights') </div>
                            <div class="software-company">@lang('app.layout.developed') <a href="https://usoft.uz"
                                    target="_blank">Usoft</a></div>
                        </div>
                        <div class="сol-md-8 col-xl-5 col-lg-4 mb-md-0 mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-6">
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a href="{{ route('site.posts.index', 'news') }}"
                                                class="nav-link">@lang('app.news.title')</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="col-md-3 col-lg-6 col-xl-3">
                                    <div
                                        class="payments d-flex justify-content-md-end justify-content-center align-items-center flex-wrap my-0">
                                        <p>@lang('app.pay_in')</p>
                                        <div
                                            class="d-flex align-items-baseline align-items-center justify-content-center flex-wrap">
                                            <div class="payments-item ml-md-4 m-3 mr-md-0 ml-md-0 my-md-0">
                                                <img class="img-fluid" src="/vendor/site/img/apelsin.png"
                                                    alt="Uzcard" />
                                            </div>

                                            <div class="payments-item ml-md-4 m-3 mr-md-0 ml-md-0 my-md-0">
                                                <img class="img-fluid" src="/vendor/site/img/uzcard.png"
                                                    alt="Uzcard" />
                                            </div>
                                            <div class="payments-item ml-md-4 m-3 mr-md-0 ml-md-0 my-md-0">
                                                <img class="img-fluid" src="/vendor/site/img/Humo.png"
                                                    alt="Humo" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 col-xl-3 col-lg-4">
                            ...
                            <div class="phone mb-3">
                                <a href="tel:{{ $setting->getPhoneOther() }}"><i class="fas fa-mobile-alt"></i>
                                    <span>{{ $setting->getPhoneOther() }} </span></a>
                            </div>
                        </div>
                        <div
                            class="col-md-3 col-lg-1 d-lg-flex justify-content-lg-end align-items-lg-start mb-md-0 mb-3">
                            <div class="socials">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('leave.feedback') }}" method="post" class="my-form my-form__auth">
                            ...
                            <div class="mt-4 my-form__group">
                                <input type="text" name="name" placeholder="@lang('app.auth.enter_name')" id="your_name"
                                    required>
                            ...
                            <div class="mt-4 my-form__group">
                                <input type="tel" name="phone" placeholder="@lang('app.auth.phone')"
                                    value="{{ auth()->user()->phone ?? '+998' }}" id="login_phone" required>
